			...
			<div className='flex flex-col justify-center gap-6 p-6'>
				...
				<div className='flex flex-col gap-6'>
					...
					<p className='text-xs text-gray-700 font-semibold'>
						At LS Digital Labs, We are pioneers of reinventing brand engagement for the digital age. With an unyielding commitment to innovation and creativity, we breathe new life into every digital
						interaction, transforming mundane moments into captivating experiences.
					</p>
